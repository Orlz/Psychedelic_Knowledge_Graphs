...
SYMM_LABELS = ["Binds"]
MAP_LABELS = {
    "POSITIVELY IMPACTS": "POSITIVELY IMPACTS",
    "NEGATIVELY IMPACTS": "NEGATIVELY IMPACTS",
    "NEEDS MORE RESEARCH BETWEEN": "NEEDS MORE RESEARCH BETWEEN",
    "NO RELATIONSHIP FOUND BETWEEN": "NO RELATIONSHIP FOUND BETWEEN", 
    "THOUGHT TO CAUSE": "THOUGHT TO CAUSE"
}

ann = "Test_Annotations.json"
...
def main(json_loc: Path, train_file: Path, dev_file: Path, test_file: Path):
    ...
    msg.info(
        f"{len(docs['total'])} training documents"
    )
